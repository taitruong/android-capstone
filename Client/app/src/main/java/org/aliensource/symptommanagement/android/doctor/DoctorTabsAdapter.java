...
import org.aliensource.symptommanagement.android.checkin.MedicationFragment;
...
public class DoctorTabsAdapter extends FragmentPagerAdapter {
    ...
    public DoctorTabsAdapter(FragmentManager fm, Activity activity, List<Medication> medications) {
        super(fm);
